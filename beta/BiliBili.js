...
// 处理 https://app.bilibili.com/x/v2/splash/list
try {
    ...
    console.error("Error in splash list processing:", e);
}

// 处理 https://app.bilibili.com/x/v2/feed/index
try {
    ...
    console.error("Error in feed index processing:", e);
}

// 处理 https://app.bilibili.com/x/resource/show/tab/v2
try {
    ...
    console.error("Error in show tab processing:", e);
}

// 处理 https://app.bilibili.com/x/v2/account/mine
try {
    ...
    console.error("Error in account mine processing:", e);
}
